...
$(document).ready(function () {
    const swiper = new Swiper('.index_ban_600 .swiper-container', {
        slidesPerView: 1.1,
        spaceBetween: 10,
        loop: true,
        observer: true,
        ...
        pagination: {
            el: '.index_ban_600 .swiper-pagination',
            clickable: true,
        },
        navigation: {
            nextEl: '.index_ban_600 .swiper-button-next',
            prevEl: '.index_ban_600 .swiper-button-prev',
        },
        breakpoints: {
            640: {
                slidesPerView: 1.7,
